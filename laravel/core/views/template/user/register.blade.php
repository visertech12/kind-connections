...
@php
    $page_title = 'UnlockThemes - Create a Free Account';
    $seo_title = 'UnlockThemes - Create a Free Account';
    $seo_description = 'Register a free UnlockThemes account to purchase premium PHP Laravel scripts, themes, and access exclusive digital services.';
    $seo_keywords = 'unlockthemes register, create account, sign up, new account, join unlockthemes';
@endphp
@section('element')
