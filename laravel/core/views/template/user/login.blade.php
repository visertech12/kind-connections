...
@php
    $page_title = 'UnlockThemes - Login to Your Account';
    $seo_title = 'UnlockThemes - Login to Your Account';
    $seo_description = 'Log in to your UnlockThemes account to manage your purchased scripts, licenses, support tickets, and hosting services.';
    $seo_keywords = 'unlockthemes login, sign in, account access, script dashboard, member login';
@endphp
@section('element')
			...
			<div class="account-content">
				<div class="account-content__top flex-between">
					...
					<div class="account-content__member flex-align">
						...
						<a href="{{route('user.register')}}" class="btn btn--account"> Register </a>
					</div>
				</div>
