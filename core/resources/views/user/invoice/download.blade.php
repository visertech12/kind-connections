            ...
            <div class="col-12">
                <div class="list--row">
                    <div class="logo float-left">
                        <img src="{{ asset('assets/images/logoIcon/logo-dark.png') }}" alt="image" class="logo-img" />
                    </div>
                ...
                <div class="info list--row d-block">
                    ...
                    <div class="info-right float-right">
                        <div class="list list--row">
                            ...
                            <span>{{ $invoice->getInvoiceNumber ?? $invoice->invid }}</span>
                        </div>
                    </div>
                </div>
                <div class="address list--row">
                    ...
                    <div class="address-form float-right">
                        <ul class="text-end">
                            ...
                            <li>
                                <span>{{ __(@$address->data_values->address ?? 'System Default Address') }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
