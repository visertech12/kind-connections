        ...
        <table class="table invoice-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td data-label="Description" class="text-start">{!! nl2br(@$item->description) !!} {!! nl2br(strip_tags(@$item->details)) !!}</td>
        ...
        <table class="table invoice-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td data-label="Amount" class="fw-bold">@if(@$trx->amountout > 0) -   ${{$trx->amountout}} @else  ${{$trx->amountin}} @endif</td>
            </tr>
            @endforeach
            <tr>
