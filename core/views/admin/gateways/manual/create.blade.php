...
<div class="page-header">
    <div>
        ...
        <div class="page-header__subtitle">Add a new manual deposit method</div>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('admin.gateway.manual.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row-3" style="margin-bottom: 20px;">
                ...
                <div>
                    <label class="form-label">Gateway Image <span class="required">*</span></label>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="instruction" required>{{ old('instruction') }}</textarea>
            ...
            <button type="submit" class="btn btn-primary" style="width: 100%;">Save Gateway</button>
        </form>
    </div>
</div>
@endsection
