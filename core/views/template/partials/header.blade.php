                            ...
                            <div class="mega-menu__inner">
                                <ul class="mega-menu-list flex-wrap">
                                    ...
                                    <li class="mega-menu-list__item violet-item">
                                        <a href="https://resources.unlockthemes.com/" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                                <i class="fa-regular fa-book-open"></i>
                                            </span>
                                            <div class="mega-menu-list__content">
                                                <span class="mega-menu-list__title">Resources</span>
                                                <p class="mega-menu-list__desc fs-14">Browse guides, insights, and updates from our resource hub.</p>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="mega-menu-list__item danger-item">
                                        <a href="https://resources.unlockthemes.com/category/case-studies/" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                                <i class="fa-regular fa-briefcase"></i>
                                            </span>
                                            <div class="mega-menu-list__content">
                                                <span class="mega-menu-list__title">Case Studies</span>
                                                <p class="mega-menu-list__desc fs-14">See real results and success stories from our clients.</p>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="mega-menu-list__item warning-item">
                                        <a href="https://unlockthemes.com/company-deck.pdf" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                                <i class="fa-regular fa-download"></i>
                                            </span>
                                            <div class="mega-menu-list__content">
                                                <span class="mega-menu-list__title">Company Deck</span>
                                                <p class="mega-menu-list__desc fs-14">Download our company profile, services, and key highlights.</p>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
