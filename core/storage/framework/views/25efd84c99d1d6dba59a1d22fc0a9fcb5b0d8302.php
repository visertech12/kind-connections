...
<header class="header  <?php if(!request()->routeIs('home')): ?> internal-page-header <?php endif; ?>" id="header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand logo" href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('assets/images/logoIcon/logo-dark.png')); ?>" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="mega-menu__inner">
                                <ul class="mega-menu-list flex-wrap">
                                    <li class="mega-menu-list__item success-item">
                                        <a href="<?php echo e(route('about')); ?>" class="mega-menu-list__link flex-wrap">
                                    ...
                                    <li class="mega-menu-list__item base-item">
                                        <a href="<?php echo e(route('support')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item info-item">
                                        <a href="<?php echo e(route('book.meeting')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                            ...
                            <div class="mega-menu__inner">
                                <ul class="mega-menu-list flex-wrap">
                                    <li class="mega-menu-list__item violet-item" data-color="#6527BE">
                                        <a href="<?php echo e(route('service.web')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item base-item">
                                        <a href="<?php echo e(route('service.app')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item info-item">
                                        <a href="<?php echo e(route('service.uiux')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item warning-item">
                                        <a href="<?php echo e(route('service.hosting')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item info-item">
                                        <a href="<?php echo e(route('service.marketing')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item violet-item">
                                        <a href="<?php echo e(route('service.consultancy')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                            ...
                            <div class="mega-menu__inner">
                                <ul class="mega-menu-list flex-wrap">
                                    ...
                                    <li class="mega-menu-list__item"  data-color="#F9322C">
                                        <a href="<?php echo e(route('product.category','php-scripts')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item"  data-color="#1b769c">
                                        <a href="<?php echo e(route('product.category','wordpress')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item"  data-color="#5fc9f8">
                                        <a href="<?php echo e(route('product.category','mobile-apps')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item"  data-color="#ff5722">
                                        <a href="<?php echo e(route('product.category','html-templates')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item"  data-color="#8e44ad">
                                        <a href="<?php echo e(route('product.category','flutter-ui')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item"  data-color="#2c3e50">
                                        <a href="<?php echo e(route('product.category','app-ui')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item"  data-color="#a259ff">
                                        <a href="<?php echo e(route('product.category','web-ui')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                    ...
                    <li class="nav-item has-mega-menu">
                        ...
                        <div class="mega-menu dropdown-menu">
                            <div class="mega-menu__inner">
                                <ul class="mega-menu-list flex-wrap">
                                    <li class="mega-menu-list__item success-item">
                                        <a href="<?php echo e(route('hosting.budget')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item base-item">
                                        <a href="<?php echo e(route('hosting.premium')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item warning-item">
                                        <a href="<?php echo e(route('hosting.vps')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item violet-item">
                                        <a href="<?php echo e(route('hosting.dedicated')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item info-item">
                                        <a href="<?php echo e(route('hosting.cluster')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item danger-item">
                                        <a href="<?php echo e(route('hosting.smtp')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item w-lg-50 w-100" data-color="#c56cf0">
                                        <a href="<?php echo e(route('domain.register')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                    ...
                    <li class="nav-item has-mega-menu">
                        ...
                        <div class="mega-menu dropdown-menu">
                            <div class="mega-menu__inner">
                                <ul class="mega-menu-list flex-wrap">
                                    <li class="mega-menu-list__item success-item">
                                        <a href="<?php echo e(route('marketing.backlink')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item base-item">
                                        <a href="<?php echo e(route('marketing.linkpyramid')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item info-item">
                                        <a href="<?php echo e(route('marketing.pr')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item" data-color="#ff793f">
                                        <a href="<?php echo e(route('marketing.advertising')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item violet-item">
                                        <a href="<?php echo e(route('marketing.branding')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                                    ...
                                    <li class="mega-menu-list__item" data-color="#009432">
                                        <a href="<?php echo e(route('marketing.seo')); ?>" class="mega-menu-list__link flex-wrap">
                                            <span class="mega-menu-list__icon flex-center fs-15">
                ...
                <div class="account-button">
                    ...
                    ?>
                    <?php if(@$tempOrdersCount): ?>
                    <a href="<?php echo e(route('hosting.order.review')); ?>" class="temp-order-display btn btn--base outline me-2">
                      <span class="temp-order-count"><?php echo e($tempOrdersCount); ?></span>
                      <i class="fa-duotone fa-cart-shopping"></i>
                    </a>
                    <?php endif; ?>
                    <?php if(auth()->guard()->guest()): ?> 
                    <a href="<?php echo e(route('user.login')); ?>" class="btn btn--base"> <span class="icon"><i class="far fa-sign-in-alt"></i></span> MY ACCOUNT</a>
                    <?php endif; ?>
                    <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('user.home')); ?>" class="btn btn--base"> <span class="icon"><i class="far fa-sign-in-alt"></i></span> MY ACCOUNT</a>
                    <?php endif; ?>
                </div>
            </div>
        </nav>
...
<?php /**PATH /home1/gepnqwpi/unlockthemes.com/core/resources/views/template/partials/header.blade.php ENDPATH**/ ?>